...
food_suggestions = [
        ...
        {'id': 5, 'content': 'Use fruit and vegetable scraps as compost instead of throwing them away'}
    ]
...
travel_suggestions = [
        ...
        {'id': 5, 'content': 'Carpool to save on gas and to help save the environment!'}
    ]
...
energy_suggestions = [
        ...
        {'id': 5, 'content': 'Make use of natural lighting to save on energy costs.'}
    ]
